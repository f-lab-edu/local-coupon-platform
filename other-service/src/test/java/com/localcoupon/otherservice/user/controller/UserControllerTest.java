...
class UserControllerTest {
  ...
  void createUser() throws Exception {
    SignUpRequestDto requestDto = new SignUpRequestDto("test@example.com", "password123", "tester",
        "서울시", "110105");
    UserResponseDto responseDto = new UserResponseDto("test@example.com", "tester", "서울시",
        "110105");
  ...
  void getUser() throws Exception {
    ...
    mockMvc.perform(get("/users/me")
            ...
            .header("X-USER-ID", "1")
            .header("X-USER-EMAIL", "test@naver.com")
  ...
  @Test
  @DisplayName("헤더에 세션정보가 없다면 404를 리턴한다.")
  void getUserNoSession() throws Exception {
    String email = "test@example.com";
    UserResponseDto responseDto = new UserResponseDto(email, "tester", "서울시", "110105");
